"""
Django settings for carters_kids_closet_45650 project.
...
ROOT_URLCONF = 'carters_kids_closet_45650.urls'
...
WSGI_APPLICATION = 'carters_kids_closet_45650.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "carters_kids_closet_45650 API",
    "DESCRIPTION": "API documentation for carters_kids_closet_45650 App",
    "VERSION": "v1",
}
